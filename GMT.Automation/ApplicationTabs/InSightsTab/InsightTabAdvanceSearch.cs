...
{
    class InSightTabAdvanceSearch
    {

        public Window advanceSearch = null;
        public Window gmtWin = null;

        public enum DateType { CreatedDate, LastModified, PublishedDate, ArchivedDate, InsightDate, OrignalPublishedDate, ReviewDate }
        ...
        public InSightTabAdvanceSearch()
        {
            Logger.Setup();
        }
        ...
        public void SelectAdvancedSearch(Window gMtWin)
        {
            ...
            advanceSearch = gMtWin.ModalWindow("Advanced Insight Search");
            gmtWin = gMtWin;
        }
        ...
        {
            bool pop = false;
            if (gmtWin.Exists(SearchCriteria.ByText("No insights were found for this search criteria.")) == true)
            {
                pop = gmtWin.Get(SearchCriteria.ByText("No insights were found for this search criteria.")).Visible;
                gmtWin.Get<Button>(SearchCriteria.ByText("OK")).Click();
            }
            return pop;
        }

        public void GeneralInsight(string title, string caseCode, string clientCompany)
        {
        advanceSearch.Get<TextBox>(SearchCriteria.ByAutomationId("txtTitle")).SetValue(title);
        advanceSearch.Get<TextBox>(SearchCriteria.ByAutomationId("txtCaseCode")).SetValue(caseCode);
            ...
            Panel insightSource = advanceSearch.Get<Panel>(SearchCriteria.ByAutomationId("ehSource"));
            ComboBox inSou = insightSource.Get<ComboBox>(SearchCriteria.ByAutomationId("CheckableCombo"));
        ...
        public void SelectKM(string kmName)
        {
            ...
            foreach(ListItem v in cb.Items)
            {
                ...
                if (kM.Name.ToString() == kmName) { kM.Click(); break; }
            }
        }
